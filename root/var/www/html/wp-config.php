<?php
    ...
    !defined('DB_PASSWORD')      && define('DB_PASSWORD',      getenv('WORDPRESS_DB_PASSWORD')    ?: 'fFoL59Ne72e1oGYZ');
    !defined('DB_HOST')          && define('DB_HOST',          getenv('WORDPRESS_DB_HOST')        ?: 'wordpress-o2nymjhy557a6z0r-svc.qovery.io');
